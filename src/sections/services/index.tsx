...
const Servicios = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      icon: <Lamp size={40} className="text-primary" />,
    ...
    },
    {
      ...
      icon: <ScrollText size={40} className="text-primary" />,
  ...
  return (
    <section
      id="servicios"
      className="w-full py-20 px-4 bg-gray-50 text-primary flex flex-col items-center"
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl w-full">
        {services.map((service, index) => (
          <div
            key={index}
            className="bg-white rounded-xl shadow-lg p-6 text-center flex flex-col items-center hover:shadow-xl hover:scale-[1.02] hover:ring-2 hover:ring-detail transition duration-300"
          >
            ...
            <ul className="text-sm text-primary list-disc text-left pl-4 space-y-1">
